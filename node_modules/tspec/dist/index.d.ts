...
declare const defaultGenerateParams: {
    specPathGlobs: string[];
    tsconfigPath: string;
    configPath: string;
    specVersion: 3;
...
declare const createJsonFile: (filePath: string, json: any) => Promise<void>;
declare const generateTspec: (generateParams?: Tspec.GenerateParams) => Promise<OpenAPIV3.Document>;

declare const initTspecServer: (options?: Tspec.InitTspecServerOptions) => Promise<void>;
declare const TspecDocsMiddleware: (generateOptions?: Tspec.GenerateParams) => Promise<express.RequestHandler[]>;

export { DEBUG, Tspec, TspecDocsMiddleware, createJsonFile, defaultGenerateParams, generateTspec, initTspecServer };
